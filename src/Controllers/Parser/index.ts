...
export function getMarkdownSections(input: string): ParsedSection[] {
...
export function getProcessedMarkdown(sections: ParsedSection[], allRules: EdithorRule[]): ParsedMarkdown {
